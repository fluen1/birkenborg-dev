...
linkedin_url: null
marginalia:
  - ts: '2026-06-17T22:57:05+02:00'
    text: 'selvbærende default + ægte-spørgsmål-slut + artikel-deling som valg'
    source: 'auto-commit'
    commit_url: 'https://github.com/fluen1/birkenborg-agents/commit/f3578b608eae0f6187ac5206fb4ebec8ad9e5a0b'
---
...
<!-- linkedin:start -->
Offentlig it-suverænitet og AI peger i hver sin retning.

Morten Kjærsgaard fra Magenta advarer: kommunernes nye regionale it-klynger må ikke gentage Strukturreformens fejl fra 2007, hvor 271 kommuner blev til 98 og big tech fyldte tomrummet med plug'n'play-løsninger. Hans svar er open source og lokal kontrol. Rimelig diagnose.

Men hvad sker der når de samme kommuner skal bruge AI? Open source giver transparens og uafhængighed. De stærkeste modeller ejes af de virksomheder man netop ville undgå. Kontrol. Kapabilitet. Vælg én.

Det er min yndlings-blinde-vinkel i debatten om offentlige it-udbud: ikke om governance-laget er rigtigt skruet sammen, men om valget af AI-model overhovedet ender i udbudsmaterialet — eller om leverandøren bare vælger selv.
